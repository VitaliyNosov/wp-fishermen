...
?>
<section class="section-slider-pages slider-pages <?php echo $bg_class; ?>" data-bg="<?php echo $bg_class; ?>">
  ...
  <div class="section-cta-content">
    <div class="wrapper">
      ...
      <?php if( $posts ): ?>
        <div class="slider-pages-holder" flex layout="row" layout-align="start stretch">
          <?php foreach( $posts as $post ): ?>
            <?php get_template_part('inc/loop/slider-services-item'); ?>
          <?php endforeach; ?>
        </div>
