...
?>
<section class="section-layout section-makers makers <?php echo $section_classes; ?>" style="<?php echo $section_styles; ?>" <?php echo $section_datas; ?>>
    ...
    <?php if ($cta_content == true) : ?>
        <div class="section-cta-content">
            <div class="wrapper">
                ...
                <div flex layout="row" layout-align="center center" style="padding:80px;">
                    MAKERS TODO
                </div>
